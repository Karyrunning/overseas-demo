...
def get_html(url):
    ...
    if html.status_code == 200:
        ...
        try:
            ...
            views = 0
        #获取点赞人数
        accept = re.compile('"accessibilityData":{"label":"(.*?) 人顶过"}')
        ...
        try:
            ...
            fans = 0
        time.sleep(0.1)
        return url,views,accepts,comments,fans
    else:
...
def data_screen():
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=10) as e:
        ...
        for futuer in tqdm(concurrent.futures.as_completed(futuers)):
            url,views,accepts,comments,fans = futuer.result()
            list_url.append(url)
...
if __name__ == '__main__':
    input_filename = 'Apex_Mobile - May 24, 2022 - 6 45 47 PM.csv'
    # 数据筛选
    data_screen()
