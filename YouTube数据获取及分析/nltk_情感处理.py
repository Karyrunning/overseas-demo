...
df1 = pd.read_csv('./output/new_BP-评论数据.csv',encoding="utf-8-sig")
...
df1['scores'] = df1['comment_text_new'].apply(lambda commentText: sid.polarity_scores(commentText))
...
df1.to_csv('./output/emotion_BP-评论数据.csv',encoding="utf-8-sig")
